...
export class RegistrationFormComponent implements OnInit, OnDestroy {
  ...
  initialiseForm() {
    ...
    this.formGroup
      ...
      console.log("this.applicationData.data?.registrationForm?.ddpName", this.applicationData.data?.registrationForm?.ddpName)
